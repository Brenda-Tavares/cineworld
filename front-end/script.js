...
const translations = {
    'pt-BR': {
        ...
        navHome: 'Início', navAbout: 'Sobre', navPrivacy: 'Privacidade', navTerms: 'Termos', 
        footerAbout: 'Sobre', footerPrivacy: 'Privacidade', footerTerms: 'Termos', 
    ...
    'en': {
        ...
        navHome: 'Home', navAbout: 'About', navPrivacy: 'Privacy', navTerms: 'Terms', 
        footerAbout: 'About', footerPrivacy: 'Privacy', footerTerms: 'Terms', 
    ...
    'es': {
        ...
        about: 'Sobre', privacy: 'Privacidad', terms: 'Términos', 
        watch: 'Ver', rent: 'Alquilar', buy: 'Comprar',
        navHome: 'Inicio', navAbout: 'Acerca de', navPrivacy: 'Privacidad', navTerms: 'Términos', 
        footerAbout: 'Acerca de', footerPrivacy: 'Privacidad', footerTerms: 'Términos', 
        watchTrailer: 'Ver Trailer',
    ...
    'zh-CN': {
        ...
        navHome: '首页', navAbout: '关于', navPrivacy: '隐私', navTerms: '条款', 
        footerAbout: '关于', footerPrivacy: '隐私', footerTerms: '条款', 
        watchTrailer: '观看预告片',
    ...
    'zh-HK': {
        ...
        footer: '© 2026 - 版權所有 | 開發',
        tagline: '發現電影和在哪裡觀看',
        about: '關於', privacy: '隱私', terms: '條款', 
        watch: '觀看', rent: '租用', buy: '購買',
        navHome: '首頁', navAbout: '關於', navPrivacy: '隱私', navTerms: '條款', 
        footerAbout: '關於', footerPrivacy: '隱私', footerTerms: '條款', 
        watchTrailer: '觀看預告片',
    ...
    'ja': {
        ...
        about: 'について', privacy: 'プライバシー', terms: '利用規約', 
        watch: '視聴', rent: 'レンタル', buy: '購入',
        navHome: 'ホーム', navAbout: 'について', navPrivacy: 'プライバシー', navTerms: '利用規約', 
        footerAbout: 'について', footerPrivacy: 'プライバシー', footerTerms: '利用規約', 
        watchTrailer: '予告編を見る',
    ...
    'ru': {
        ...
        about: 'О нас', privacy: 'Конфиденциальность', terms: 'Условия', 
        watch: 'Смотреть', rent: 'Аренда', buy: 'Купить',
        navHome: 'Главная', navAbout: 'О нас', navPrivacy: 'Конфиденциальность', navTerms: 'Условия', 
        footerAbout: 'О нас', footerPrivacy: 'Конфиденциальность', footerTerms: 'Условия', 
    ...
    'ko': {
        ...
        about: '정보', privacy: '개인정보', terms: '이용약관', 
        watch: '시청', rent: '대여', buy: '구매',
        navHome: '홈', navAbout: '정보', navPrivacy: '개인정보', navTerms: '이용약관', 
        footerAbout: '정보', footerPrivacy: '개인정보', footerTerms: '이용약관', 
        watchTrailer: '예고편 보기',
...
function setupEvents() {
    ...
    // Language (handled by lang-selector.js)
...
function renderMovies() {
    ...
    container.innerHTML = state.movies.map((movie, index) => {
        const year = movie.release_date ? sanitize(movie.release_date.split('-')[0]) : '';
        const rating = movie.vote_average ? sanitize(movie.vote_average.toFixed(1)) : '';
            ...
            <div class="movie-card" role="listitem" tabindex="0" 
                ...
                <div class="movie-info">
                    ...
                    <div class="movie-meta">
                        ...
                        ${movie.production_countries?.[0]?.name ? `<span>${sanitize(movie.production_countries[0].name)}</span>` : ''}
                    </div>
                </div>
            </div>
        `;
...
const legalPagePaths = {
    'pt-BR': { about: '/sobre', privacy: '/privacidade', terms: '/termos' },
...
function showMovieModal(movie) {
    ...
    const safeTitle = sanitize(movie.title);
    
    titleEl.textContent = safeTitle;
    
    let genresHtml = '';
    if (movie.genres && movie.genres.length > 0) {
        genresHtml = movie.genres.map(g => `<span>${sanitize(g.name)}</span>`).join('');
    }
        ...
        <div class="modal-flex">
            ...
            <div class="modal-details">
                ...
                <div class="modal-tags">
                    ...
                    ${year ? `<span>${year}</span>` : ''}
                    ${movie.runtime ? `<span>${sanitize(String(movie.runtime))} min</span>` : ''}
                </div>
                <div class="modal-tags">
                    ${genresHtml}
                </div>
                ${streamingHtml}
                <p class="modal-desc">${sanitize(movie.overview || t('synopsisNotAvailable'))}</p>
                ${movie.original_title !== movie.title ? 
                    `<p><strong>${t('originalTitle')}:</strong> ${sanitize(movie.original_title)}</p>` : ''}
                ${trailerLink ? `
                <a href="${trailerLink}" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   class="trailer-btn"
                   aria-label="${t('watchTrailer')} - ${safeTitle}">
